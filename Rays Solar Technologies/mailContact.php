...
$paramsName = $_POST["InputName"];
$paramsEmail = $_POST["InputEmail"];
$paramsPhone = $_POST["InputPhone"];
$paramstextData = $_POST["InputMessage"];
	...
	$message .= "<p>Following are the details of the customer who shown interest</p>";

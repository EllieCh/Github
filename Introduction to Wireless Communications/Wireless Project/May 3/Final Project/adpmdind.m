...
c2=sqrt(0.5011)*(randn(1,size)+(sqrt(-1)*randn(1,size))); 
c3=sqrt(0.1)*(randn(1,size)+(sqrt(-1)*randn(1,size))); 
c4=sqrt(0.0158)*(randn(1,size)+(sqrt(-1)*randn(1,size))); 
c5=sqrt(0.002511)*(randn(1,size)+(sqrt(-1)*randn(1,size)));  
c6=sqrt(0.000630)*(randn(1,size)+(sqrt(-1)*randn(1,size))); 
...
plot(snr_db,Spectral_Efficency,'-ob')   
title('Spectral Efficieny for Indoor Channnel using Adaptive Modulation ');
xlabel('SNR');
